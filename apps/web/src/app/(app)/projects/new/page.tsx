    ...
    <div className="px-8 py-8">
      ...
      <header className="mb-6 max-w-3xl">
        ...
        <p className="mt-1 text-sm text-zinc-400">
          A project is the unit of isolation in WorkBrain — every document, decision, link
          and search lives inside one project. Cross-project queries are forbidden by
          design. You can have many projects per client (e.g. one per system the client
          operates).
        </p>
      </header>
